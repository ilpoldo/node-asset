var Asset, Buffer, Gzip, Package, Task, closure_compile, compressGzip, fs, log, path, resolveContents, sys, watch, yui_compile;
Gzip = require('compress').Gzip;
closure_compile = require('closure-compiler').compile;
...
watch = function(package) {
  return package.contents.forEach(function(asset) {
    return fs.watchFile(asset.path, {interval: 3000}, function(curr, prev) {
